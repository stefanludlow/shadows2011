...
int wieldHandCount(int race,int skill)
{
	...
	case SKILL_HEAVY_PIERCE:
		if (race == 21 || race == 119 || race == 120 || race == 24) // Mountains and Mirks and Snaga and hobbits, no go
			return 0;
	...
	case SKILL_LONGBOW:
		// hobbits, dwarves, mountains, mirkwoods, snaga, balchoth (both types)  - no longbow
		if (race == 21 || race == 23 || race == 119 || race == 120 || race == 24 || race == 128 || race == 130)
			return 0;
