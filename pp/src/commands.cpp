...
const class command_data commands[] = {
	...
	{"checkpay", do_checkPay, DEAD, C_DEL | C_HID | C_BLD},
	...
	{"rdesc", do_rdesc, REST, C_HID | C_SUB | C_DOA | C_PAR}, /* leader-command or level 1 */
	...
	{"rname", do_rname, REST, C_HID | C_SUB | C_DOA | C_PAR}, /* leader-command or level 1 */
	...
	{"set", do_set, DEAD,
	C_DEL | C_HID | C_SUB | C_DOA | C_BLD | C_PAR | C_SPL},
	{"setpay", do_setPay, DEAD, C_DEL | C_HID | C_BLD},
